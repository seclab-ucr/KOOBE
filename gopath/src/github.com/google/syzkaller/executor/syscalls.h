...
const call_t syscalls[] = {
    ...
    {"setsockopt$inet6_autoflow", 366},
    {"setsockopt$inet6_bool", 366},
...
const call_t syscalls[] = {
    ...
    {"setsockopt$inet6_autoflow", 54},
    {"setsockopt$inet6_bool", 54},
...
const call_t syscalls[] = {
    ...
    {"setsockopt$inet6_autoflow", 294},
    {"setsockopt$inet6_bool", 294},
...
const call_t syscalls[] = {
    ...
    {"setsockopt$inet6_autoflow", 208},
    {"setsockopt$inet6_bool", 208},
...
const call_t syscalls[] = {
    ...
    {"setsockopt$inet6_autoflow", 339},
    {"setsockopt$inet6_bool", 339},
